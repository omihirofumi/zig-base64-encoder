...
const zig_base64_encoder = @import("zig_base64_encoder");
...
fn _calc_encode_length(input: []const u8) !usize {
    ...
    const n_gourps: usize = try std.math.divCeil(usize, input.len, 3);
    return n_gourps * 4;
}
...
pub fn main() !void {
    ...
    try zig_base64_encoder.bufferedPrint();

    const base64 = Base64.init();
    std.debug.print("Chracter at index 28: {c}\n", .{base64._char_at(28)});
}
